...
if ( ! function_exists( 'nomad_sun_setup' ) ) :
	...
	function nomad_sun_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'nomad_sun_custom_background_args', array(
...
function nomad_sun_scripts() {
	wp_enqueue_style( 'nomad-sun-style', get_stylesheet_uri() );
...
// here we have a function that returns us a nicely formatted image 

function nice_background ($image_field) {
	// we pass in our image field, and it returns us
