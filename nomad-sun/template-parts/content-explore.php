<div class="container center ph4-l mb5 mb6-l">
    <h2 class="archivo f2 center tc ttu 1h-title mv0 explore-title">
    Let's Explore Together
    </h2>
        <div class="flex-m flex-l flex-wrap justify-between">
            <?php
                // organize our options into a data object
                    $args = array(
                    'posts_per_page' => 3,
                    'orderby' => 'rand',
                    // here we make sure to exclude the current 
                    // post we are looking at 
                ...
                <!-- here we create a 1x1 aspect ratio box -->
                    <div class="aspect-ratio aspect-ratio--1x1">
                        <!-- our inner element taked up the full width and height -->
                        <div class="aspect-ratio--object bg-center cover flex items-center justify-center ph3 " style="<?php nice_background('hero_image');?>">
                            <p class="archivo white mv0 ttu tracked f5 f4-l tc 1l-title"><?php the_title(); ?></p>
                        </div>
                    </div>
                </a>
            <?php endwhile; endif; ?>
